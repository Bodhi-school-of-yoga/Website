...
export const founder: Founder = {
  ...
  pullQuote:
    "Today's life is fast-paced and hectic, the ethos acquisitive, cynical and self-centred. In this scenario, to become a yoga teacher is a beautiful choice. It is a choice to not be cynical, to love society and be a force for good.",
  paragraphs: [
