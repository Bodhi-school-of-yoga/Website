...
export type CourseHighlight = { icon: string; title: string; body: string };
...
export const COURSES: Course[] = [
  ...
  // ===========================================================
  {
    ...
    highlights: [
      { icon: "yoga", title: "Advanced Techniques & Philosophy", body: "Four streams of Yoga (Raja, Karma, Bhakti, Jnana) plus 70+ advanced asanas." },
      { icon: "leaf", title: "Classical Texts", body: "Vedas, Upanishads, Patanjali's Yoga Sutras, Bhagavad Gita." },
      { icon: "align-center", title: "Sequencing & Adjustments", body: "Alignment, biomechanics, and safe hands-on adjustments." },
      { icon: "strength", title: "Advanced Pranayama & Kriya", body: "Pranayama, mudras, bandhas, kriya yoga and shat kriyas." },
      { icon: "rocket", title: "Flexible Online Format", body: "12-week schedule, weekday evenings, recordings included." },
      { icon: "people", title: "RYT 300 Community", body: "Global cohort of advanced teachers." },
    ],
    curriculum: [
  ...
  },
  {
    ...
    highlights: [
      { icon: "yoga", title: "Trimester-Specific Asana", body: "Safe modifications for first, second, and third trimesters." },
      { icon: "leaf", title: "Preconception to Postnatal", body: "Whole-journey curriculum including Mom & Baby yoga." },
      { icon: "align-center", title: "Acupressure & Energy", body: "Acupressure points, mudras, and energetic practices for pregnancy." },
      { icon: "smile", title: "Handling Complications", body: "Hormonal shifts, thyroid, diabetes, depression — safe modifications." },
      { icon: "rocket", title: "Yoga Alliance RPYT", body: "Curriculum aligned with Registered Prenatal Yoga Teacher standards." },
      { icon: "people", title: "Expert Panel", body: "Faculty includes prenatal yoga teachers, doctors, and birth specialists." },
    ],
    curriculum: [
  ...
  },
  {
    ...
    highlights: [
      { icon: "yoga", title: "36 Yoga Poses", body: "Age-appropriate asana set designed for children." },
      { icon: "smile", title: "Brain Games & Stories", body: "Story-based teaching and brain games that hold attention." },
      { icon: "leaf", title: "Chakras & Koshas", body: "Energy-body and subtle-body theory adapted for kids." },
      { icon: "align-center", title: "Mindfulness for Kids", body: "Pranayama, mudras, trataka kriya, and yoga nidra." },
      { icon: "people", title: "Sequencing Across Age Groups", body: "Different sequences for different developmental stages." },
      { icon: "rocket", title: "Yoga Alliance RCYT", body: "Registered Children's Yoga Teacher pathway." },
    ],
    curriculum: [
  ...
  },
  {
    ...
    highlights: [
      { icon: "leaf", title: "Classical & Modern", body: "Fundamental texts, Patanjali Sutras, Vedanta, and integrative yoga therapy." },
      { icon: "align-center", title: "Energy Anatomy & Therapy", body: "Subtle anatomy, mudra therapy, and yoga psychology." },
      { icon: "yoga", title: "Ayurveda & Naturopathy", body: "Traditional Indian medicine and yogic wellness science." },
      { icon: "technology", title: "Research Methodology", body: "Study design, statistics, and academic writing." },
      { icon: "rocket", title: "Jyotish Yoga Sastra University", body: "Degree partner: Jyotish Yoga Sastra University, Florida." },
      { icon: "people", title: "9-Member Faculty", body: "Senior teachers, therapists, and yoga researchers." },
    ],
    curriculum: [
  ...
  },
  {
    ...
    highlights: [
      { icon: "technology", title: "Original Research", body: "Choose your own research question under faculty supervision." },
      { icon: "leaf", title: "Classical & Modern Lens", body: "Bridge traditional yoga wisdom with contemporary science." },
      { icon: "align-center", title: "Publish & Present", body: "Support to publish in peer-reviewed journals and present at conferences." },
      { icon: "people", title: "Senior Faculty Mentorship", body: "1:1 guidance from experienced yoga researchers." },
      { icon: "yoga", title: "Applied Practice", body: "Integrate teaching, therapy, or fieldwork into your research." },
      { icon: "rocket", title: "Jyotish Yoga Sastra University", body: "Doctorate awarded by Jyotish Yoga Sastra University, Florida." },
    ],
    curriculum: [
  ...
  // ===========================================================
  {
    ...
    highlights: [
      { icon: "yoga", title: "70+ Advanced Asanas", body: "Inversions, arm balances, and deep backbends with safe progressions." },
      { icon: "align-center", title: "Meditation & Breathwork", body: "Advanced pranayama, mudras, bandhas, and meditation." },
      { icon: "leaf", title: "Vedas & Upanishads", body: "All four Vedas and the major Upanishads studied in depth." },
      { icon: "strength", title: "Biomechanics & Anatomy", body: "Functional anatomy and Kriya Yoga." },
      { icon: "rocket", title: "Therapeutic Applications", body: "Apply yoga to common conditions and student needs." },
      { icon: "people", title: "RYT 500 Designation", body: "Eligible for Yoga Alliance RYT 500." },
    ],
    curriculum: [
      { title: "Four Streams of Yoga", body: "Raja, Karma, Bhakti, and Jnana yoga in depth." },
  ...
  // ===========================================================
  {
    ...
    highlights: [
      { icon: "yoga", title: "100+ Asanas", body: "Surya Namaskara variations and Ashtanga Viniyasa A/B." },
      { icon: "leaf", title: "Pranayama & Mudras", body: "10 pranayama, mudras, bandhas, and shat kriyas." },
      { icon: "align-center", title: "Anatomy & Energy Anatomy", body: "12 body systems plus Pancha Koshas." },
      { icon: "people", title: "Live Cohort", body: "Small batches with peer practicum and feedback." },
      { icon: "rocket", title: "RYT 200 Pathway", body: "Yoga Alliance registered curriculum and certification." },
      { icon: "smile", title: "Add-On Modules", body: "Prenatal, Yoga Therapy, and MAT Pilates introductions." },
    ],
    curriculum: [
  ...
  },
  {
    ...
    highlights: [
      { icon: "yoga", title: "Toning & Anti-Ageing", body: "Lift, firm, and tone without injections or surgery." },
      { icon: "leaf", title: "Lymphatic Drainage", body: "Face mapping plus drainage routines that reduce puffiness." },
      { icon: "smile", title: "Acupressure", body: "Energy points and face mapping practices." },
      { icon: "align-center", title: "Facial Tools", body: "Gua sha, face-rollers, and self-massage protocols." },
      { icon: "people", title: "Skin Detox & Nutrition", body: "Skin nutrition and yogic detox practices." },
      { icon: "rocket", title: "Niche Certification", body: "Stand out in the wellness market with a rare skill set." },
    ],
    curriculum: [
  ...
  },
  {
    ...
    highlights: [
      { icon: "strength", title: "Six Foundational Principles", body: "Concentration, control, centring, flow, precision, breathing." },
      { icon: "align-center", title: "Functional Core & Breathing", body: "True deep-core engagement and lateral thoracic breathing." },
      { icon: "yoga", title: "Yoga-Pilates Integration", body: "Hybrid class templates that blend both traditions." },
      { icon: "leaf", title: "Modifications for Injuries", body: "Safe progressions and adaptations for common conditions." },
      { icon: "people", title: "Beginner → Advanced", body: "Progress students from foundations through advanced repertoire." },
      { icon: "rocket", title: "Globally Recognised", body: "Certification accepted by studios and gym chains." },
    ],
    curriculum: [
  ...
  },
  {
    ...
    highlights: [
      { icon: "strength", title: "Targeted Workouts", body: "Asana sequences, Shakthi Bandhana, Pilates, Sun Salutations." },
      { icon: "leaf", title: "Yogic Diet & Naturopathy", body: "Yogic diet, meal plans, detox, naturopathy, water." },
      { icon: "smile", title: "Mantras & Mudras", body: "Energetic and meditative tools for the journey." },
      { icon: "yoga", title: "Personalised Plans", body: "Tailor workouts and nutrition to each client." },
      { icon: "people", title: "Coaching Skills", body: "Intake, goal-setting, weekly check-ins, accountability." },
      { icon: "rocket", title: "Business Toolkit", body: "Pricing, packages, and business models for online coaches." },
    ],
    curriculum: [
  ...
  // ===========================================================
  {
    ...
    highlights: [
      { icon: "yoga", title: "100+ Asanas", body: "Surya Namaskara variations and Ashtanga Viniyasa A & B." },
      { icon: "feather", title: "Aerial & Acro Yoga", body: "Bonus modules in aerial hammock and partner acro practice." },
      { icon: "align-center", title: "Anatomy & Energy Anatomy", body: "12 body systems plus Pancha Koshas." },
      { icon: "leaf", title: "Pranayama, Mudras & Bandhas", body: "Energetic locks, gestures, and breath work." },
      { icon: "people", title: "Studio Sangha", body: "Practise, study, and teach alongside your cohort." },
      { icon: "rocket", title: "Add-On Modules", body: "Prenatal, Yoga Therapy, and MAT Pilates introductions." },
    ],
    curriculum: [
      { title: "Theory — Ashtanga, Sutras & Koshas", body: "Eight limbs, Patanjali Sutras, Pancha Koshas, yogic diet, ethics." },
  ...
  },
  {
    ...
    highlights: [
      { icon: "feather", title: "Yoga Meets Flight", body: "Combine traditional poses with graceful aerial movements." },
      { icon: "spine", title: "Relieve & Realign", body: "Inversions decompress the spine and boost flexibility." },
      { icon: "smile", title: "Therapeutic & Fun", body: "Enjoy emotional release through playful, healing practice." },
      { icon: "strength", title: "Build Strength", body: "Improve core stability, balance, and control." },
      { icon: "rocket", title: "Teach with an Edge", body: "Gain a rare certification and grow your yoga career." },
      { icon: "people", title: "Join a Community", body: "Connect with passionate practitioners and expert teachers." },
    ],
    curriculum: [
  ...
  },
  {
    ...
    highlights: [
      { icon: "strength", title: "Shoulder Health", body: "Build resilient, mobile shoulders through 360° loading." },
      { icon: "align-center", title: "Rotational Power", body: "Develop torso strength that transfers to every sport." },
      { icon: "yoga", title: "Breath-Linked Flow", body: "Pair mace work with yogic breath patterns." },
      { icon: "leaf", title: "Joint Mobility", body: "Open shoulders, thoracic spine, and hips safely." },
      { icon: "people", title: "Coach Group Classes", body: "Class formats for 5–25 people across skill levels." },
      { icon: "rocket", title: "Niche Specialisation", body: "Rare credential in the modern yoga and fitness market." },
    ],
    curriculum: [
  ...
  // ===========================================================
  {
    ...
    durationLabel: "Ongoing · 50-min sessions",
    scheduleLabel: WEEKDAY_SCHEDULE,
    listingImage: "/images/programs/pranayama.jpg",
    heroImage: "/images/programs/pranayama.jpg",
    ...
    highlights: [
      { icon: "yoga", title: "All Ages Welcome", body: "Low-impact sequences designed for every fitness level." },
      { icon: "leaf", title: "Flexible Slots", body: "Morning (4 am – 11 am) and evening (5 pm – 8 pm) time slots." },
      { icon: "smile", title: "Live & Replays", body: "Join live or watch the recording within 24 hours." },
      { icon: "align-center", title: "Rotating Themes", body: "Strength, flexibility, breath, and meditation each week." },
      { icon: "people", title: "Bodhi Community", body: "Practise alongside a friendly global community." },
      { icon: "rocket", title: "₹50 / Day", body: "Affordable membership with no long-term commitment." },
    ],
    curriculum: [
  ...
  },
  {
    ...
    highlights: [
      { icon: "yoga", title: "Targeted Yoga", body: "Dynamic flows, twists, and inversions that move stuck energy." },
      { icon: "leaf", title: "Mindful Eating", body: "Sustainable food habits — no crash dieting." },
      { icon: "strength", title: "Daily Movement", body: "Weekday yoga sessions with progressive intensity." },
      { icon: "smile", title: "Happy, Not Harsh", body: "Joy-led programme — celebrate progress, not punish." },
      { icon: "people", title: "Daily Check-ins", body: "Accountability messaging and coach support throughout the 21 days." },
      { icon: "rocket", title: "Lasting Results", body: "Habits and tools that stay long after the programme ends." },
    ],
    curriculum: [
  ...
  },
  {
    ...
    highlights: [
      { icon: "yoga", title: "Advanced Asana", body: "Inversions, arm balances, and deep flexibility work." },
      { icon: "strength", title: "Pilates Conditioning", body: "Core, pelvic floor, and stability sessions." },
      { icon: "align-center", title: "Posture & Alignment", body: "Detailed cues for refined alignment." },
      { icon: "leaf", title: "Breath-Linked Flow", body: "Sequencing that honours breath rhythm at every step." },
      { icon: "people", title: "Small Cohort", body: "Limited live spots so the teacher can see you." },
      { icon: "rocket", title: "Progress Tracking", body: "Monthly milestones to track your practice growth." },
    ],
    curriculum: [
  ...
  // ===========================================================
  {
    ...
    highlights: [
      { icon: "yoga", title: "All Levels Welcome", body: "From absolute beginner to seasoned practitioner." },
      { icon: "leaf", title: "Weekday Schedule", body: "Mon – Fri mornings and evenings — no weekend classes." },
      { icon: "smile", title: "Studio Sangha", body: "Practise alongside a friendly local community." },
      { icon: "align-center", title: "Hands-On Adjustments", body: "Real-time consent-led adjustments from your teacher." },
      { icon: "strength", title: "Rotating Themes", body: "Strength, flexibility, breath, and meditation each week." },
      { icon: "rocket", title: "Unlimited Membership", body: "One monthly fee for unlimited classes." },
    ],
    curriculum: [
