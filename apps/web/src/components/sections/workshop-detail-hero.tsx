...
export function WorkshopDetailHero({
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="relative z-10 mx-auto flex w-full max-w-[1200px] flex-col items-stretch gap-12 lg:flex-row lg:items-start lg:justify-between lg:gap-12 page-px"
