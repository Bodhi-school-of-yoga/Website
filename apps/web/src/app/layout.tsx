      ...
      <body className="min-h-full flex flex-col bg-transparent">
        ...
        <Providers>
          ...
          {/* <a
            ...
            className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-full bg-[#25D366] shadow-[0_4px_14px_rgba(0,0,0,0.15)] transition-transform duration-200 hover:scale-110 active:scale-95"
          >
            <svg viewBox="0 0 32 32" className="h-6 w-6 sm:h-7 sm:w-7 text-white" fill="currentColor">
